...
def report(
    ...
    with md_path.open("w", encoding="utf-8") as f:
        ...
        f.write(f"- Содержит столбцы с большим числом уникальных значений: **{quality_flags['has_high_cardinality_categoricals']}**\n")
        f.write(f"- Содержит дубликаты id: **{quality_flags['has_suspicious_id_duplicates']}**\n\n")
